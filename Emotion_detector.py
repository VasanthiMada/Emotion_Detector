...
while True:
    ...
    # UI canvas for emotion probabilities
    ...
    for (x, y, w, h) in faces:
        ...
        if np.sum([roi_gray]) != 0:
            ...
            # Draw face bounding box and emotion label
    ...
    # Resize and display both frame and UI
    ...
    time.sleep(0.5)  # <-- Slow down to ~10 frames per second
